...
return [
    ...
    'password_max_length' => 'パスワードは:max文字以下である必要があります。',
    'password_require_lowercase' => 'パスワードには小文字を含める必要があります。',
    'password_require_uppercase' => 'パスワードには大文字を含める必要があります。',
    ...
    'requirements_lowercase' => '小文字を含む',
    'requirements_uppercase' => '大文字を含む',
    'requirements_numbers' => '数字を含む',
    'requirements_symbols' => '記号を含む（:symbols）',
];